...
import { MODELS_DEV_PROVIDER_DESCRIPTORS } from "@dude1wudv/pi-catalog/provider-models/openai-compat";
import type { OpenAICompat } from "@dude1wudv/pi-catalog/types";
