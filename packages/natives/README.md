...
```typescript
import { encodeSixel, grep, pdfToMarkdown } from "@dude1wudv/pi-natives";
...
`@dude1wudv/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @dude1wudv/pi-natives-<platform>-<arch>
