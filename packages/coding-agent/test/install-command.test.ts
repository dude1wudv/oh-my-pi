...
import { commands, isSubcommand, resolveCliArgv } from "@dude1wudv/pi-coding-agent/cli-commands";
import { looksLikeLocalPath } from "@dude1wudv/pi-coding-agent/commands/install";
...
describe("looksLikeLocalPath", () => {
	...
	test("npm specs and marketplace refs are remote", () => {
		expect(looksLikeLocalPath("@dude1wudv/exa")).toBe(false);
