...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@dude1wudv/pi-coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@dude1wudv/pi-coding-agent/tools";
