...
import * as configModule from "@dude1wudv/pi-coding-agent/config";
import * as shim from "@dude1wudv/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
import * as utils from "@dude1wudv/pi-utils";
