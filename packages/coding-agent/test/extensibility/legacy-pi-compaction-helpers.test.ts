...
} from "@dude1wudv/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
...
// `@dude1wudv/pi-agent-core/compaction` and the coding-agent barrel does not
...
describe("legacy shim compaction helpers", () => {
	...
	// Issue #7174: `compact` (same `@dude1wudv/pi-agent-core/compaction` module as
