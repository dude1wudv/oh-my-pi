...
import { __computeBundledSelfPackageRoot } from "@dude1wudv/pi-coding-agent/extensibility/plugins/legacy-pi-compat";
...
describe("legacy pi compat bundled-self package root computation", () => {
	it("derives the npm prebuilt bundle package root from dist import.meta.dir", () => {
		...
		const posixMetaDir = "/home/me/.bun/install/global/node_modules/@dude1wudv/pi-coding-agent/dist";
		expect(__computeBundledSelfPackageRoot(posixMetaDir, path.posix)).toBe(
			"/home/me/.bun/install/global/node_modules/@dude1wudv/pi-coding-agent",
		);
	});
