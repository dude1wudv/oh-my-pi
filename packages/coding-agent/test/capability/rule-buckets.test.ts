...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@dude1wudv/pi-coding-agent/capability/rule";
import { bucketRules } from "@dude1wudv/pi-coding-agent/capability/rule-buckets";
