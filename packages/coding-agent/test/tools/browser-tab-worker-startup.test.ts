...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@dude1wudv/pi-coding-agent/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "@dude1wudv/pi-coding-agent/tools/browser/tab-supervisor";
