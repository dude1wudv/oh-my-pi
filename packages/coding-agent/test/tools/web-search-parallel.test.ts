...
import { searchWithParallel } from "@dude1wudv/pi-coding-agent/web/parallel";
import { searchParallel } from "@dude1wudv/pi-coding-agent/web/search/providers/parallel";
