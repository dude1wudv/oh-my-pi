...
import { handleArxiv } from "@dude1wudv/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@dude1wudv/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@dude1wudv/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@dude1wudv/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@dude1wudv/pi-coding-agent/web/scrapers/types";
