...
import { handleChocolatey } from "@dude1wudv/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@dude1wudv/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@dude1wudv/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@dude1wudv/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@dude1wudv/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@dude1wudv/pi-coding-agent/web/scrapers/terraform";
