...
import { handleCratesIo } from "@dude1wudv/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@dude1wudv/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@dude1wudv/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@dude1wudv/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@dude1wudv/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@dude1wudv/pi-coding-agent/web/scrapers/pypi";
