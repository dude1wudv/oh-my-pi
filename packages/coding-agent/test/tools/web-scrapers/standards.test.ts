...
import { handleCheatSh } from "@dude1wudv/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@dude1wudv/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@dude1wudv/pi-coding-agent/web/scrapers/tldr";
