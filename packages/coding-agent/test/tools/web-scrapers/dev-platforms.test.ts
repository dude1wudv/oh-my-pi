...
import { handleDevTo } from "@dude1wudv/pi-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@dude1wudv/pi-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@dude1wudv/pi-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@dude1wudv/pi-coding-agent/web/scrapers/lobsters";
