...
import { handleAur } from "@dude1wudv/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@dude1wudv/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@dude1wudv/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@dude1wudv/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@dude1wudv/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@dude1wudv/pi-coding-agent/web/scrapers/rubygems";
