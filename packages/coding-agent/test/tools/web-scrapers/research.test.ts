...
import { handleBiorxiv } from "@dude1wudv/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@dude1wudv/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@dude1wudv/pi-coding-agent/web/scrapers/wikidata";
