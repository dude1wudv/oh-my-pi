...
import { handleArtifactHub } from "@dude1wudv/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@dude1wudv/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@dude1wudv/pi-coding-agent/web/scrapers/discogs";
