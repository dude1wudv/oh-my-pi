...
import type { SettingPath } from "@dude1wudv/pi-coding-agent/config/settings-schema";
...
import { type CoordinationDetails, HubTool, isIrcEnabled } from "@dude1wudv/pi-coding-agent/tools/hub";
