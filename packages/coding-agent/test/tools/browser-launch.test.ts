...
import { Browser, computeExecutablePath, detectBrowserPlatform, resolveBuildId } from "@dude1wudv/pi-utils/browsers";
import { APP_NAME } from "@dude1wudv/pi-utils/dirs";
