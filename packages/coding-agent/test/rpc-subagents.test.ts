...
import { RpcClient } from "@dude1wudv/pi-coding-agent/modes/rpc/rpc-client";
import {
	handleRpcSessionChange,
	type RpcSessionChangeCommand,
	type RpcSessionChangeResult,
	type RpcSessionChangeSession,
} from "@dude1wudv/pi-coding-agent/modes/rpc/rpc-mode";
import { RpcSubagentRegistry, readRpcSubagentTranscript } from "@dude1wudv/pi-coding-agent/modes/rpc/rpc-subagents";
...
} from "@dude1wudv/pi-coding-agent/task";
