 ...
 * @dude1wudv/pi-natives (native Rust addon via glob). We cannot call it here.
 *
...
import type { InstalledPluginEntry } from "@dude1wudv/pi-coding-agent/extensibility/plugins/marketplace";
import {
	addInstalledPlugin,
	buildPluginId,
	readInstalledPluginsRegistry,
	writeInstalledPluginsRegistry,
} from "@dude1wudv/pi-coding-agent/extensibility/plugins/marketplace";
import { removeSyncWithRetries } from "@dude1wudv/pi-utils";

// ── Inline validator ───────────────────────────────────────────────────────────
//
// Mirrors parseClaudePluginsRegistry() in discovery/helpers.ts exactly.
// Kept here to avoid importing helpers.ts (which pulls in @dude1wudv/pi-natives).
...
// Matches getConfigDirName() — single source of truth is in @dude1wudv/pi-utils,
