...
import { listOmpExtensionRoots } from "@dude1wudv/pi-coding-agent/discovery/omp-extension-roots";
import { getEnabledPlugins } from "@dude1wudv/pi-coding-agent/extensibility/plugins/loader";
