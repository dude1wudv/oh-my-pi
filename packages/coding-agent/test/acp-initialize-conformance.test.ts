...
import { ACP_TERMINAL_AUTH_FLAG, prepareAcpTerminalAuthArgs } from "@dude1wudv/pi-coding-agent/modes/acp/terminal-auth";
...
import { getConfigRootDir, setAgentDir, VERSION } from "@dude1wudv/pi-utils";
import type { AgentSideConnection, InitializeRequest } from "@dude1wudv/pi-utils/acp";
