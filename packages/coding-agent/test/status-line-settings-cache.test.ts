...
import { StatusLineComponent, type StatusLineSettings } from "@dude1wudv/pi-coding-agent/modes/components/status-line";
import { STATUS_LINE_PRESETS } from "@dude1wudv/pi-coding-agent/modes/components/status-line/presets";
import { initTheme } from "@dude1wudv/pi-coding-agent/modes/theme/theme";
import * as git from "@dude1wudv/pi-coding-agent/utils/git";
import { removeSyncWithRetries, setProjectDir } from "@dude1wudv/pi-utils";
