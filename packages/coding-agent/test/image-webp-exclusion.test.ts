...
import type { Api, Message, Model } from "@dude1wudv/pi-ai";
...
import { SessionProviderBoundary } from "@dude1wudv/pi-coding-agent/session/session-provider-boundary";
import {
	modelLacksWebpSupport,
	normalizeModelContextImages,
	normalizeModelContextMessages,
	webpExclusionForModel,
} from "@dude1wudv/pi-coding-agent/utils/image-loading";
