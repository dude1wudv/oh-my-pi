...
import { discoverAndLoadExtensions } from "@dude1wudv/pi-coding-agent/extensibility/extensions/loader";
import { getAgentDir, getPluginsDir, removeSyncWithRetries, setAgentDir, TempDir } from "@dude1wudv/pi-utils";

const currentPiCodingAgentPath = Bun.resolveSync("@dude1wudv/pi-coding-agent", import.meta.dir);
const currentPiExtensionsPath = Bun.resolveSync("@dude1wudv/pi-coding-agent/extensibility/extensions", import.meta.dir);
