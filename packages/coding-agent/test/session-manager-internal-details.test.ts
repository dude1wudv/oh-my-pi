...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@dude1wudv/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@dude1wudv/pi-coding-agent/session/session-entries";
