...
import * as skillsModule from "@dude1wudv/pi-coding-agent/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "@dude1wudv/pi-coding-agent/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@dude1wudv/pi-coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
...
describe("autoloadSkills in executor", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@dude1wudv/pi-coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
