...
import { RpcSubagentRegistry } from "@dude1wudv/pi-coding-agent/modes/rpc/rpc-subagents";
import type { RpcSubagentFrame } from "@dude1wudv/pi-coding-agent/modes/rpc/rpc-types";
import { AgentLifecycleManager } from "@dude1wudv/pi-coding-agent/registry/agent-lifecycle";
import type { AgentRef } from "@dude1wudv/pi-coding-agent/registry/agent-registry";
...
import { createPersistedSubagentReviverFactory } from "@dude1wudv/pi-coding-agent/task/persisted-revive";
