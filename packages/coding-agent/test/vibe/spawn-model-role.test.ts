...
import type { ExecutorOptions } from "@dude1wudv/pi-coding-agent/task/executor";
...
import { type VibeCli, VibeSessionRegistry } from "@dude1wudv/pi-coding-agent/vibe/runtime";
