...
import { loadCapability } from "@dude1wudv/pi-coding-agent/capability";
import { clearCache as clearFsCache } from "@dude1wudv/pi-coding-agent/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "@dude1wudv/pi-coding-agent/discovery/helpers";
import { loadSlashCommands } from "@dude1wudv/pi-coding-agent/extensibility/slash-commands";
import { discoverAgents } from "@dude1wudv/pi-coding-agent/task/discovery";
import { __resetDirsFromEnvForTests, removeWithRetries, setAgentDir } from "@dude1wudv/pi-utils";
import "@dude1wudv/pi-coding-agent/discovery/claude-plugins";
import { type MCPServer, mcpCapability } from "@dude1wudv/pi-coding-agent/capability/mcp";
import type { Skill } from "@dude1wudv/pi-coding-agent/capability/skill";
import type { SlashCommand } from "@dude1wudv/pi-coding-agent/capability/slash-command";
