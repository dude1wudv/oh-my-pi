...
import { type Rule, ruleCapability } from "@dude1wudv/pi-coding-agent/capability/rule";
import type { LoadContext } from "@dude1wudv/pi-coding-agent/capability/types";
// Importing discovery registers all providers as a side effect.
import { loadCapability } from "@dude1wudv/pi-coding-agent/discovery";
