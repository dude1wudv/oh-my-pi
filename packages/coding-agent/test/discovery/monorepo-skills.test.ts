...
import type { LoadContext, LoadResult } from "@dude1wudv/pi-coding-agent/capability/types";
import { scanSkillsFromDir } from "@dude1wudv/pi-coding-agent/discovery/helpers";
