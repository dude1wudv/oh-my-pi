...
import { type Skill, skillCapability } from "@dude1wudv/pi-coding-agent/capability/skill";
import { type SlashCommand, slashCommandCapability } from "@dude1wudv/pi-coding-agent/capability/slash-command";
import { loadCapability } from "@dude1wudv/pi-coding-agent/discovery";
import { getConfigRootDir, removeWithRetries, setAgentDir } from "@dude1wudv/pi-utils";
