...
import {
	...
	parseAgentPluginMcp,
} from "@dude1wudv/pi-coding-agent/discovery/agent-plugin-format";
import {
	clearClaudePluginRootsCache,
	injectPluginDirRoots,
	listClaudePluginRoots,
} from "@dude1wudv/pi-coding-agent/discovery/helpers";
import { getPluginsDir, removeWithRetries } from "@dude1wudv/pi-utils";
import "@dude1wudv/pi-coding-agent/discovery/agent-plugins";
import "@dude1wudv/pi-coding-agent/discovery/claude-plugins";
import type { MCPServer } from "@dude1wudv/pi-coding-agent/capability/mcp";
