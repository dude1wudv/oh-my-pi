...
import { renderSearchResult, type SearchRenderDetails } from "@dude1wudv/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@dude1wudv/pi-coding-agent/web/search/types";
