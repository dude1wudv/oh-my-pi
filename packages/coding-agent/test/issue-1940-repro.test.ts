...
import { SttClient } from "@dude1wudv/pi-coding-agent/stt/asr-client";
import type { SttWorkerInbound, SttWorkerOutbound } from "@dude1wudv/pi-coding-agent/stt/asr-protocol";
