...
import type { ScopedModel } from "@dude1wudv/pi-coding-agent/config/model-resolver";
import { Settings } from "@dude1wudv/pi-coding-agent/config/settings";
import { buildSessionOptions } from "@dude1wudv/pi-coding-agent/main";
import { type CreateAgentSessionOptions, createAgentSession } from "@dude1wudv/pi-coding-agent/sdk";
...
import { CURRENT_SESSION_VERSION, type SessionHeader } from "@dude1wudv/pi-coding-agent/session/session-entries";
