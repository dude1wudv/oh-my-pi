...
import { loadHooks } from "@dude1wudv/pi-coding-agent/extensibility/hooks/loader";
import { ExtensionExitError, withHostGuard } from "@dude1wudv/pi-coding-agent/extensibility/utils";
...
describe("extension/hook loader process.exit guard (#3680)", () => {
	...
	const runGuardedShutdownProbe = (trigger: "sigint" | "fatal") => {
		...
		return runProbe(`
import { postmortem } from "@dude1wudv/pi-utils";
import { withHostGuard } from "@dude1wudv/pi-coding-agent/extensibility/utils";
