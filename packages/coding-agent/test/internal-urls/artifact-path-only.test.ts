...
import { ArtifactProtocolHandler } from "@dude1wudv/pi-coding-agent/internal-urls/artifact-protocol";
...
import { resolveToolSearchScope } from "@dude1wudv/pi-coding-agent/tools/path-utils";
