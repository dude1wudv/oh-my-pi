...
import { Effort, type FetchImpl, type Model } from "@dude1wudv/pi-ai";
import type { OAuthCredentials } from "@dude1wudv/pi-ai/oauth/types";
import { buildModel } from "@dude1wudv/pi-catalog/build";
import { writeModelCache } from "@dude1wudv/pi-catalog/model-cache";
import { getBundledModel } from "@dude1wudv/pi-catalog/models";
import { resolveModelCacheProviderId, resolveOllamaModelCacheProviderId } from "@dude1wudv/pi-catalog/provider-models";
import type { ModelSpec, OpenAICompat } from "@dude1wudv/pi-catalog/types";
import {
	applyLlamaCppQwenThinking,
	discoverOllamaModels,
	discoveryProbeTimeoutMs,
} from "@dude1wudv/pi-coding-agent/config/model-discovery";
import { kNoAuth, ModelRegistry } from "@dude1wudv/pi-coding-agent/config/model-registry";
import { ProviderDiscoverySchema } from "@dude1wudv/pi-coding-agent/config/models-config-schema";
