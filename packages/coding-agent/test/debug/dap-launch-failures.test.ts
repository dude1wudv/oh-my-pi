...
import * as dapModule from "@dude1wudv/pi-coding-agent/dap";
import { connectSocket, DapClient, waitForTcpServerListening } from "@dude1wudv/pi-coding-agent/dap/client";
import { DapSessionManager } from "@dude1wudv/pi-coding-agent/dap/session";
import type {
	DapCapabilities,
	DapClientState,
	DapEventMessage,
	DapResolvedAdapter,
} from "@dude1wudv/pi-coding-agent/dap/types";
import type { ToolSession } from "@dude1wudv/pi-coding-agent/tools";
import { DebugTool } from "@dude1wudv/pi-coding-agent/tools/debug";
