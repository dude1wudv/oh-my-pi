...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@dude1wudv/pi-coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@dude1wudv/pi-coding-agent/mcp/types";
