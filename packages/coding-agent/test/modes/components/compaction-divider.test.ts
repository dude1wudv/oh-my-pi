...
import { createCompactionSummaryMessage } from "@dude1wudv/pi-agent-core/compaction";
import type { ImageContent } from "@dude1wudv/pi-ai";
import { CompactionSummaryMessageComponent } from "@dude1wudv/pi-coding-agent/modes/components/compaction-summary-message";
