...
import type { AsyncJobRegisterOptions } from "@dude1wudv/pi-coding-agent/async/job-manager";
import { Settings } from "@dude1wudv/pi-coding-agent/config/settings";
import { resolveLocalRoot } from "@dude1wudv/pi-coding-agent/internal-urls/local-protocol";
import { TanCommandController } from "@dude1wudv/pi-coding-agent/modes/controllers/tan-command-controller";
