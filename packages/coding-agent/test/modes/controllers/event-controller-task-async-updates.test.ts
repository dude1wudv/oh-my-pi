...
import type { ToolExecutionComponent } from "@dude1wudv/pi-coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@dude1wudv/pi-coding-agent/task/types";
import type { BashToolDetails } from "@dude1wudv/pi-coding-agent/tools/bash";
