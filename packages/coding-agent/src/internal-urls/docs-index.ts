 ...
 * written by `gen:bundle`) — so `/pi-coding-agent/*` SDK consumers
...
import { isEnoent, logger } from "@dude1wudv/pi-utils";
 ...
 * SDK consumers importing `/pi-coding-agent/*` load TypeScript source, where
