import type { AgentOptions } from "@dude1wudv/pi-agent-core";
import type { OAuthAccessResolution } from "@dude1wudv/pi-ai";
import type { ApiKeyResolver } from "@dude1wudv/pi-ai/auth-retry";
