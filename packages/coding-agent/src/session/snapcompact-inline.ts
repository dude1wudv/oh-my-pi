...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@dude1wudv/pi-ai";
...
// Per-provider image-count budgets live in /snapcompact
