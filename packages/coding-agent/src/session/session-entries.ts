...
import type { ImageContent, MessageAttribution, ServiceTierByFamily, TextContent } from "@dude1wudv/pi-ai";
...
declare module "@dude1wudv/pi-agent-core/compaction/entries" {
