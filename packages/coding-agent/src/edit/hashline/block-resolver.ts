 ...
 * `/pi-natives`, which infers the language from the file path and
 * returns the 1-indexed line span of the syntactic block beginning on the
 * requested line (or `null` when none can be resolved).
 */
import type { BlockResolver } from "@dude1wudv/hashline";
import { blockRangeAt } from "@dude1wudv/pi-natives";
