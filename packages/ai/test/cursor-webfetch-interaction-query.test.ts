...
import type { InteractionQuery, InteractionResponse } from "@dude1wudv/pi-catalog/discovery/cursor-proto";
import {
...
import { create, fromBinary, toBinary } from "@dude1wudv/pi-catalog/discovery/protobuf";
