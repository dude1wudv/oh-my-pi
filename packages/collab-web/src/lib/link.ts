 ...
 * link/envelope half of `@dude1wudv/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@dude1wudv/pi-wire";
import {
	DEFAULT_RELAY_URL,
	...
	ROOM_KEY_BYTES,
	WRITE_TOKEN_BYTES,
} from "@dude1wudv/pi-wire";

export { COLLAB_PROTO } from "@dude1wudv/pi-wire";
