...
- Reimplemented the Zod compatibility facade (`@dude1wudv/omptype/zod`) to run purely on internal mechanics, removing the dependency on `zod`.
...
- Added TypeBox-style (@dude1wudv/omptype/typebox) and Zod-style (@dude1wudv/omptype/zod) authoring adapters that produce native omptype schemas.
