 ...
 * to a small model (default `google-antigravity/gemini-3.7-flash` via `@dude1wudv/pi-ai`)
...
import { type Api, completeSimple, Effort, type Model, type Tool, type ToolCall } from "@dude1wudv/pi-ai";
import { discoverAuthStorage } from "@dude1wudv/pi-ai/auth-broker";
