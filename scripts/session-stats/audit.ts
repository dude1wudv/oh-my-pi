 ...
 * asks a small model (default: anthropic/claude-sonnet-4-6 via /pi-ai)
 * to judge:
...
import { type GeneratedProvider, getBundledModel } from "/pi-catalog/models";
import { getAgentDbPath, isEnoent } from "/pi-utils";
