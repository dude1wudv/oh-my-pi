 ...
 *
 * Routes through /pi-ai (`completeSimple`) rather than raw HTTP so model
...
import type { Api, AssistantMessage, Model } from "/pi-ai";
import type { GeneratedProvider } from "/pi-catalog/models";
import { getBundledModel } from "/pi-catalog/models";
